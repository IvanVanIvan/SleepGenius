...
class LandingPage:
    ...
    def open_login_page(self):
        # Open the SG_Version3\Login_PageV3.py file using subprocess
        subprocess.Popen(["python", "SG_Version3\Login_PageV3.py"])
        # Close the main screen
        self.main_screen.destroy()

    # function to open register page
    def open_register_page(self):
        # Open the SG_Version3\Register_PageV3.py file using subprocess
        subprocess.Popen(["python", "SG_Version3\Register_PageV3.py"])
        # Close the main screen
        self.main_screen.destroy()
