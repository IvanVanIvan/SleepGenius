...
class HistoryResults:
    def __init__(self):
        ...
        self.message_label = tk.Label(
            self.HistoryScreen,
            text="Sleep results from this week",
            bg="black",
            fg="#0CC0DF")
        # Set the position of the label
        ...
        self.msgInptP_label = tk.Label(
            self.HistoryScreen,
            text="Input another result",
            bg="black",
            fg="#0CC0DF",
            width="20",
            height="1",
        ...
        self.logout_button = tk.Button(
            ...
            width="10",
            cursor="hand2",
            command=self.input_another_result)
        # Set the position of the button
        ...
        cursor.execute(
            "SELECT * FROM UsersSleepData WHERE User_Name=?", (username,))
        # get the rows
        row = cursor.fetchone()
        # close database
        conn.close()
        ...
        if row:
            ...
            for i in range(1, 8):
                # Assuming there are 7 columns for hours slept (from 1 to 7)
            ...
            self.no_data_label = tk.Label(
                self.HistoryScreen,
                text="No sleep Data entered this week",
                bg="black",
                fg="white",
                highlightthickness=2,
                highlightbackground="#FFDE59",
    ...
    def input_another_result(self):
        ...
        self.clearHoursTXT()
        # Open the SG_Version4\SleepData_InputV4.py file using subprocess
        subprocess.Popen(["python", "SG_Version4\\SleepData_InputV4.py"])
