...
class LoginPage:
    ...
    def login(self):
        ...
        # connect cursor
        cursor = conn.cursor()
        # look for the data in the data base, that matches the username and
        # password
    ...
    def open_register_page(self):
        # Open the SG_Version4\Register_PageV4.py file using subprocess
        subprocess.Popen(["python", "SG_Version4\\Register_PageV4.py"])
