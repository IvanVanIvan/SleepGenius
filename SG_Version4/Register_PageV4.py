...
class RegisterPage:
    def __init__(self):
        ...
        self.username_register_entry = tk.Entry(
            self.registration_screen, textvariable=self.username_verify)
        # Set the position of the label
        ...
        # Create an Entry widget
        self.password_register_entry = tk.Entry(
            self.registration_screen,
    ...
    def register_user(self):
        ...
        if not re.match("^[a-zA-Z]+$", username):
            # Show an error message if the username contains non-letter
            # characters
    ...
    def open_login_page(self):
        # Open the SG_Version4\Login_PageV4.py file using subprocess
        subprocess.Popen(["python", "SG_Version4\\Login_PageV4.py"])
