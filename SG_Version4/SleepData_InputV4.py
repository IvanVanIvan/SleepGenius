...
class InputPage:
    def __init__(self):
        ...
        self.message_label = tk.Label(
            self.Input_screen,
            text="Please enter your sleep data below",
            bg="black",
            fg="#0CC0DF")
        # Set the position of the label
        ...
        try:
            ...
            if 1 <= hours_slept <= 24:
                ...
                messagebox.showwarning(
                    "Invalid Input",
                    "The number of hours slept should be between 1 and 24.")
        except ValueError:
    ...
    def open_result_page(self):
        # Open the SG_Version4\Result_PageV4.py file using subprocess
        subprocess.Popen(["python", "SG_Version4\\Result_PageV4.py"])
